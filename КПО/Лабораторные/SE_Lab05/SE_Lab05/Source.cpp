...
#if (defined(TEST_CREATE_01)+defined(TEST_CREATE_02)+defined(TEST_ADDENTRY_03)+defined(TEST_ADDENTRY_04)+defined(TEST_GETENTRY_05)+defined(TEST_GETENTRY_06)+defined(TEST_UPDENTRY_07)+defined(TEST_UPDENTRY_08)+defined(TEST_UPDENTRY_08)+defined(TEST_DICTIONARY))>1
...
//		dictionary::AddEntry(d2, s2);
//		dictionary::AddEntry(d2, s3);
//		dictionary::Entry newEntry2 = { 3,"Николаев" };
//		dictionary::UpdEntry(d2, 3, newEntry2);
//		dictionary::DelEntry(d2, 2);
//		dictionary::Print(d2);
//		Delete(d1);
